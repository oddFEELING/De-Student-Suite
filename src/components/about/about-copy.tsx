...
const AboutCopy: React.FC = () => {
  return (
    <section className='relative isolate w-full overflow-hidden bg-white py-24 sm:py-32'>
      <div
        className='absolute -top-80 left-[max(6rem,33%)] -z-10 transform-gpu blur-3xl sm:left-1/2 md:top-20 lg:ml-20 xl:top-3 xl:ml-56'
        aria-hidden='true'
      >
        <div
          className='aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-cyan-500 to-[#8b83ff] opacity-30'
          style={{
            clipPath:
      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:mx-0'>
          <p className='text-lg font-semibold leading-8 tracking-tight text-cyan-600'>
            About De Student Suite
          </p>
        ...
        <div className='mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12'>
          <div className='relative lg:order-last lg:col-span-5'>
            ...
            <motion.figure
              className='border-l border-cyan-500 pl-8'
            ...
            >
              ...
              <figcaption className='mt-8 flex gap-x-4'>
                ...
                <div className='text-sm leading-6'>
                  ...
                  <div className='text-gray-600'>@_oddfeeling</div>
                </div>
              </figcaption>
            </motion.figure>
          </div>
