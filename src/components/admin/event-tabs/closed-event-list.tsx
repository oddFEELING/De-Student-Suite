                ...
                >
                  ...
                  <div className='flex-1 truncate w-full border-b border-gray-200 pb-2'>
                    <div className='flex items-center space-x-3 mt-2'>
                      ...
                      <span className='inline-flex flex-shrink-0 items-center rounded-full bg-rose-50 px-1.5 py-0.5 text-xs font-medium text-rose-700 ring-1 ring-inset ring-rose-600/20'>
                        {event.status}
                      </span>
                    </div>
                  ...
                  <div className='flex-1 grid grid-cols-2 gap-3 w-full pt-3'>
                    <button className='flex items-center gap-2 justify-center py-2 text-sm w-full col-span-2 border rounded-md shadow transition-all duration-150 ease-out hover:shadow-md bg-emerald-600 text-white hover:bg-emerald-500'>
...
export default ClosedEventsList;
